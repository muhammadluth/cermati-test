                ...
                <div className="card text-white">
                  <div className="card-body view-card-newsletter">
                    ...
                    <p className="card-text newsletter-text">
                      I write articles related to web technologies, such as
                      design trends, development tools, UI/UX case studies and
                      reviews, and more. Sign up to my newsletter to get them
                      all.
                    </p>
                    <div className="row">
                      <div className="col-xl-9 col-md-12 col-sm-12 view-newsletter">
                        <input
                          ...
                          onChange={event => this.props.setEmail(event)}
